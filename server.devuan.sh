...
127.0.0.1  localhost
EOF
/etc/init.d/bind9 restart && update-rc.d bind9 enable
...
/etc/init.d krb5-kdc stop > /dev/null 2>&1
...
/etc/init.d/nfs-server stop > /dev/null 2>&1
/etc/init.d/rpcbind stop > /dev/null 2>&1

rm -rf /srv/nfs > /dev/null 2>&1
